...
\begin{algorithm}
\begin{algorithmic}[1]
\Function{avanzar}{capacidad, tamanoActual, beneficioActual, indiceItemActual, itemsAgregados, mejorBeneficio}
	\While{hayItemDespuesDe(indiceItemActual) $\land$ \Call{podaPorOptimalidad}{capacidad, tamanoActual, beneficioActual, nuevoItem, mejorBeneficio}}
		\State $nuevoItem \gets items[indiceItemActual]$
		\State $itemsAgregados[indiceItemActual] \gets$ \Call{podaPorFactibilidad}{capacidad, tamanoActual, nuevoItem}
		\If{itemsAgregados[indiceItemActual]}
...
\begin{algorithm}
\begin{algorithmic}[1]
\Function{retroceder}{itemsAgregados, indiceItemActual, tamanoActual, beneficioActual}
	\While{$indiceItemActual \geq 0 \land \lnot$ itemsAgregados[indiceItemActual]}
		\State $indiceItemActual -= 1$
	\EndWhile
