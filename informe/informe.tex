...
\begin{algorithm}
\begin{algorithmic}[1]
\Function{avanzar}{capacidad, indiceItemActual, itemsAgregados, mejorBeneficio}
...
\begin{algorithm}
\begin{algorithmic}[1]
\Function{retroceder}{itemsAgregados, indiceItemActual}
