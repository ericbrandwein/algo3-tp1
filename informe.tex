...
\Function{backtracking}{$capacidad, items$}
	...
	\State $solucion \gets $\Call{proximaSolucion}{capacidad, itemsOrdenados, solucion}
	\While{esValida(solucion)}
...
\EndFunction
\\
\Function{proximaSolucion}{$capacidad, itemsOrdenados, solucionActual$}
\EndFunction
\end{algorithmic}
\end{algorithm}
