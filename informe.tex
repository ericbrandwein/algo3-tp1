...
Sacar los inservibles hace que no pueda haber dos combinaciones con el mismo tamaño en la segunda mitad. Esto se debe a que, si hubiese dos con el mismo tamaño, alguna tendría menor o igual beneficio que la otra, y por lo tanto la habríamos sacado. Además, esa mitad está ordenada por beneficio. Veamos que esto es cierto.
Sabemos que está ordenada por tamaño de menor a mayor, porque no cambiamos el orden que teníamos antes. Por lo mismo, también sabemos que si hubiese dos combinaciones de igual tamaño, la que tenga el mayor beneficio estará primera. Cuando sacamos las partes Además, si había una combinación con mayor o igual tamaño y menor o igual beneficio que uno anterior, ya lo sacamos.
